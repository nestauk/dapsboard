...
export const getPathName = string => path.parse(string).name;
...
// export const groupByDatasetByVersion = _.pipe([
  //   _.groupBy(_.getKey('dataset')),
  //   _.mapValuesWith(_.indexBy(getVersion))
  // ]);
