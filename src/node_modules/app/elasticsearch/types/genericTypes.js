...
export const getArrayCellType = _.getKey('itemsType');

// enums
const enumsKey = 'enums';
export const enumsD = _shape(enumsKey);
export const enums = enumsD();
export const enumsOf = (__values, __default, __isAppDefault) => ({
	...isNotNil(__default) ? {__default} : {},
	...isNotNil(__isAppDefault) ? {__isAppDefault} : {},
	...enums,
	__values,
...
export const xorOf = obj => mergeObj(xor)({
...
export const extentOf = (fieldType, __default, __isAppDefault) => ({
	...isNotNil(__default) ? {__default} : {},
	...isNotNil(__isAppDefault) ? {__isAppDefault} : {},
	[shapeKey]: extentKey,
	min: fieldType,
...
export const intWithUnitOf = (units, defaultUnit) => ({
	...intWithUnitD(),
	__value: integerD(1),
	__unit: enumsOf(units, defaultUnit)
});
