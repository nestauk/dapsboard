...
const anyKey = 'any'
export const any = _shape(anyKey)();
...
// pair
export const pairD = _shape('pair');
...
// some
const someKey = 'some';
export const someD = _shape(someKey);
...
export const intWithinExtent = {
	..._shape('intWithinExtent'),
	...integer,
	min: integer,
	max: integer,
};
export const intWithin = ([min, max], __default, __isAppDefault) => ({
...
export const numberWithin = ([min, max], __default, __isAppDefault) => ({
	...isNotNil(__default) ? {__default} : {},
	...isNotNil(__isAppDefault) ? {__isAppDefault} : {},
	...numberWithinExtent,
	min,
