...
export const _type = str => (__default, __isAppDefault) => ({
...
export const _shape = str => (__default, __isAppDefault) => ({
	...isNotNil(__default) ? {__default} : {},
	...isNotNil(__isAppDefault) ? {__isAppDefault} : {},
	[shapeKey]: str,
});
...
// native
export const booleanD = _type('boolean');

export const floatKey = 'float';
export const floatD = _type(floatKey);

export const integerKey = 'integer';
export const integerD = _type('integer');
export const stringD = _type('string');
...
// array
export const arrayD = _shape('array');
export const array = arrayD();
export const arrayOf = (itemsType, __default, __isAppDefault) => ({
	...isNotNil(__default) ? {__default} : {},
	...isNotNil(__isAppDefault) ? {__isAppDefault} : {},
	...array,
	itemsType,
...
export const enumsOf = (values, __default, __isAppDefault) => ({
	...isNotNil(__default) ? {__default} : {},
	...isNotNil(__isAppDefault) ? {__isAppDefault} : {},
	...enums,
	values,
});
const is_enums = is_shape(enumsKey);
...
export const extentOf = ({min, max}, __default, __isAppDefault) => ({
	...isNotNil(__default) ? {__default} : {},
	...isNotNil(__isAppDefault) ? {__isAppDefault} : {},
	[shapeKey]: extentKey,
	min,
...
export const hasDefault = _.hasKey('__default');
export const hasNoDefault = _.not(hasDefault);
export const hasESdefault =
	obj => isNotNil(obj.__default) && !obj.__isAppDefault;
