...
export type BucketAggregations<Dataset, Fields extends keyof Dataset> = {
    ...
    histogram: MetricAggregationConfig<Dataset, Fields> & {
        /**
         * When the aggregation executes, the price field of every document will
         * be evaluated and will be rounded down to its closest bucket. Must be
         * a positive decimal.
         */
