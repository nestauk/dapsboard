<script>
	...
	const configXorObjectEditor = type => objectEditor({
		typeObject: {
			__selected: enumSelection(type),
			...type
		}
	});
	*/
	const configXorObjectEditor = type => {
		console.log('xor', type)
		return objectEditor({
			typeObject: {
				__selected: enumSelection(type),
				...type
	...
	const getEditor = _.adapter([
		...
		_.casus(is_xor, configXorObjectEditor),
