...
import {
	getSuggestionsQuery,
	makeGetSuggestionsBy
} from 'elasticsearch/types/suggestions';
...
function selectNextSearchField (ctx) {
	...
	if (nextFieldNames[selectedFieldName]) {
		ctx.userSelection.set(nextFieldNames[selectedFieldName]);
...
function selectPrevSearchField (ctx) {
	...
	if (prevFieldNames[selectedFieldName]) {
		ctx.userSelection.set(prevFieldNames[selectedFieldName]);
		ctx.selectedFieldName.set(getFieldSelection(
			fieldStats,
			userSelection
		));
