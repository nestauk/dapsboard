...
import { buildAggregation, getDefaultValue } from 'app/elasticsearch';
...
function computeDefaultValues (ctx) {
	...
	completions.forEach(c => {
		if (c.required) {
			defaultValues[c.name] = getDefaultValue(selection.aggregation, dataset, selection.field, c.displayText, c.name);
		}
	})
...
function computeRequestInternal (
	...
	const defaultValues = get(machine.context.defaultValues);
