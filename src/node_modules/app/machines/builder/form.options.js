...
const processParams = _.pipe([
	tapValue('as is'),
	_.mapWith(info => [info.name, processParam(info.type)]),
	tapValue('processed'),
...
function computeDefaultValuesInternal (aggParamsInfo) {
	...
	return processParams(aggParamsInfo);
}
...
function processRequestValue (params, name, value, type) {
	...
	if (!value) {
		return
	} else if (is_object(type) || is_xor(type)) {
