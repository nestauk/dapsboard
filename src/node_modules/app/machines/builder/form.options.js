...
export const formOptions = {
	actions: {
		 ...
		 */
		// sendRequested: choose([{
		// 	cond: 'isUserInteraction',
		// 	actions: [sendParent('REQUESTED', {delay: 1})],
		// }]),
		sendRequested: sendParent('REQUESTED', {delay: 1}),
		/**
		 * Notifies parent that query was requested.
		 */
	...
	guards: {
		...
		/*
		isUserInteraction: ctx => {
			console.log('checing if is user interaction', get(ctx.isUserInteraction))
			return get(ctx.isUserInteraction);
		}
		*/
	},
	services: {
